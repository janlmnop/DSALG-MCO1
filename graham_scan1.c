 ...
 * algorithm using selection sort (slow sorting algorithm).
************************************************************************************/
#include <stdio.h>
#include <math.h>
#include <time.h> 
...
/**
 * Apply Graham's Scan Algorithm on the given set of points using selection sort (slow sorting algorithm)
 * @param points array of n points
 ...
 * @tester: Janelle Ann F. Daguiso
 */
void grahamScanSlowAlgo(struct Point points[], struct Stack *S, int n) {
    ...
    // apply slow sorting algorithm
    selectionSort(points, angles, n-1);
